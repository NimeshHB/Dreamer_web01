    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
          <h3> 🎌 Learn Japanese with Confidence and Clarity | Dreamer Academy </h3>
          <p class="fst-italic">
            At Dreamer Academy, we believe that learning Japanese should be simple, engaging, and empowering. Whether you're a complete beginner or looking to improve your skills, our expert-designed lessons help you build a strong foundation in speaking, reading, writing, and listening.

          </p>
          <ul>
            <li><i class="bi bi-check-circle"></i> <span> Practical Japanese for real-life use</span></li>
            <li><i class="bi bi-check-circle"></i> <span>Clear grammar explanations and cultural tips</span></li>
            <li><i class="bi bi-check-circle"></i> <span>Step-by-step lessons from basic to advanced</span></li>
            <li><i class="bi bi-check-circle"></i> <span> Friendly support and guidance every step of the way</span></li>
          </ul>
          <a href="news.php" class="read-more"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
        </div>
  ...
  <section id="about" class="about section">
    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
          <h3>Learn Japanese with Confidence & Clarity</h3>
          <p class="fst-italic">
            Step into a world of new opportunities by mastering the language of Japan. Whether you're a student,
            traveler, or language enthusiast – our expert-led classes are designed just for you.
          </p>
          <ul>
            <li><i class="bi bi-check-circle"></i> <span>Interactive and beginner-friendly sessions.</span></li>
            <li><i class="bi bi-check-circle"></i> <span>Experienced and supportive instructors.</span></li>
            <li><i class="bi bi-check-circle"></i> <span>Learn speaking, reading, and writing from day one.</span></li>
          </ul>
