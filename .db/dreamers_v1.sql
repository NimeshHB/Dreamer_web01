...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2025 at 07:46 PM
...
INSERT INTO `cities` (`id`, `districts_id`, `name_en`, `name_si`, `name_ta`, `sub_name_en`, `sub_name_si`, `sub_name_ta`, `postcode`, `latitude`, `longitude`) VALUES
...
--
-- Table structure for table `class_assign_teachers`
--

CREATE TABLE `class_assign_teachers` (
  `id` int(11) NOT NULL,
  `class_shedule_id` int(11) NOT NULL,
  `course_has_teacher_id` int(11) NOT NULL,
  `class_teachet_roles_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `class_shedule` (
  ...
  `class_shedule_status_id` int(11) NOT NULL,
...
--
-- Table structure for table `class_shedule_status`
--

CREATE TABLE `class_shedule_status` (
  `id` int(11) NOT NULL,
  `status` varchar(45) DEFAULT NULL COMMENT 'pending , ongoing , missed , leaved'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `class_shedule_status`
--

INSERT INTO `class_shedule_status` (`id`, `status`) VALUES
(1, 'Pending'),
(2, 'Ongoing'),
(3, 'Missed'),
(4, 'Leaved');
...
--
-- Table structure for table `class_student_attendance`
--

CREATE TABLE `class_student_attendance` (
  `id` int(11) NOT NULL,
  `course_has_student_id` int(11) NOT NULL,
  `class_shedule_id` int(11) NOT NULL,
  `status` tinyint(4) DEFAULT 1 COMMENT '0 => inactive , 1=> active',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
...
--
-- Table structure for table `class_teachet_roles`
--

CREATE TABLE `class_teachet_roles` (
  `id` int(11) NOT NULL,
  `role` varchar(45) DEFAULT NULL COMMENT 'Primary Instructor,Assistant Instructor,Guest Lecturer'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `class_teachet_roles`
--

INSERT INTO `class_teachet_roles` (`id`, `role`) VALUES
...
CREATE TABLE `course` (
  ...
  `status` tinyint(4) DEFAULT 1 COMMENT '0 => inactive , 1=> active',
  `is_show_public` tinyint(4) DEFAULT 0,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `districts` (`id`, `provinces_id`, `name_en`, `name_si`, `name_ta`) VALUES
...
--
-- Table structure for table `evenet_status`
--

CREATE TABLE `evenet_status` (
  `id` int(11) NOT NULL,
  `status` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `evenet_status`
--

INSERT INTO `evenet_status` (`id`, `status`) VALUES
(1, 'Scheduled'),
(2, 'Ongoing'),
(3, 'Completed'),
(4, 'Cancelled');
...
CREATE TABLE `event` (
  ...
  `description` text DEFAULT NULL,
  `evenet_status_id` int(11) NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `event_oraganizer`
--

CREATE TABLE `event_oraganizer` (
  `id` int(11) NOT NULL,
  `event_shedule_id` int(11) NOT NULL,
...
CREATE TABLE `event_participants` (
  ...
  `event_participants_status_id` int(11) NOT NULL,
  `note` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `event_participants_status`
--

CREATE TABLE `event_participants_status` (
  `id` int(11) NOT NULL,
  `status` varchar(45) DEFAULT NULL COMMENT 'Registered'', ''Attended'', ''Cancelled'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `event_participants_status`
--

INSERT INTO `event_participants_status` (`id`, `status`) VALUES
(1, 'Registered'),
(2, 'Attended'),
(3, 'Not Attended'),
(4, 'Cancelled');
...
--
-- Table structure for table `event_shedule`
--

CREATE TABLE `event_shedule` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `event_type` (
  `id` int(11) NOT NULL,
  `type` varchar(45) DEFAULT NULL COMMENT 'Workshop'', ''Seminar'', ''Cultural Event'', ''Language Exchange'', ''Other'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `payment_currency` (
  `id` int(11) NOT NULL,
  `currency` varchar(45) DEFAULT NULL COMMENT 'LKR , JPY'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `payment_currency` (`id`, `currency`) VALUES
(1, 'LKR'),
(2, 'JPY');
...
CREATE TABLE `payment_expenses` (
  `id` int(11) NOT NULL,
  `payment_expenses_type_id` int(11) NOT NULL,
  `expenses_name` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `payment_expenses_details`
--

CREATE TABLE `payment_expenses_details` (
  `id` int(11) NOT NULL,
  `payment_expenses_id` int(11) NOT NULL,
...
--
-- Table structure for table `payment_expenses_type`
--

CREATE TABLE `payment_expenses_type` (
  `id` int(11) NOT NULL,
  `type` varchar(45) DEFAULT NULL COMMENT 'Electricity'', ''Water'', ''Internet'', ''Rent'', ''Other'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `payment_expenses_type`
--

INSERT INTO `payment_expenses_type` (`id`, `type`) VALUES
(1, 'Electricity'),
(2, 'Water'),
(3, 'Internet'),
(4, 'Rent'),
...
CREATE TABLE `payment_method` (
  `id` int(11) NOT NULL,
  `method` varchar(45) DEFAULT NULL COMMENT 'Bank Transfer'', ''Credit Card'', ''Cash'', ''Online Payment'', ''Other'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `payment_salaries`
--

CREATE TABLE `payment_salaries` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `payment_salaries_staff_bank_details`
--

CREATE TABLE `payment_salaries_staff_bank_details` (
  `id` int(11) NOT NULL,
  `payment_salaries_staff_role_id` int(11) NOT NULL,
...
--
-- Table structure for table `payment_salaries_staff_paid_details`
--

CREATE TABLE `payment_salaries_staff_paid_details` (
  `id` int(11) NOT NULL,
  `payment_salaries_staff_role_id` int(11) NOT NULL,
  `basic` double DEFAULT NULL,
  `ot` double DEFAULT NULL,
  `bounes` double DEFAULT NULL,
...
--
-- Table structure for table `payment_salaries_staff_role`
--

CREATE TABLE `payment_salaries_staff_role` (
  `id` int(11) NOT NULL,
  `payment_salaries_id` int(11) NOT NULL,
...
CREATE TABLE `payment_status` (
  `id` int(11) NOT NULL,
  `status` varchar(45) DEFAULT NULL COMMENT 'Pending'', ''Completed'', ''Failed'', ''Refunded'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `payment_student_details`
--

CREATE TABLE `payment_student_details` (
  `id` int(11) NOT NULL,
  `payment_student_id` int(11) NOT NULL,
  `paid_for` varchar(45) DEFAULT NULL,
  `payment_course_id` int(11) DEFAULT 0,
  `description` text DEFAULT NULL,
  `paid_date` date DEFAULT NULL,
  `amount` double DEFAULT 0,
  `discount` double DEFAULT 0,
  `panalty` double DEFAULT 0,
  `total` double DEFAULT 0,
  `payment_method_id` int(11) NOT NULL,
  `payment_currency_id` int(11) NOT NULL,
  `payment_status_id` int(11) NOT NULL,
...
--
-- Table structure for table `sms_n_email`
--

CREATE TABLE `sms_n_email` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `message` text DEFAULT NULL,
  `platform` varchar(45) DEFAULT NULL COMMENT 'SMS , Email',
  `send_datetime` datetime DEFAULT NULL,
  `sms_n_email_status_id` int(11) NOT NULL,
  `delivered_datetime` datetime DEFAULT NULL,
  `note` varchar(255) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `sms_n_email_category_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `sms_n_email_category`
--

CREATE TABLE `sms_n_email_category` (
  `id` int(11) NOT NULL,
  `category` varchar(45) DEFAULT NULL COMMENT 'Reminder , promotion'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `sms_n_email_category`
--

INSERT INTO `sms_n_email_category` (`id`, `category`) VALUES
(1, 'Normal'),
(2, 'Reminder'),
(3, 'Promotion'),
(4, 'OTP'),
...
--
-- Table structure for table `sms_n_email_status`
--

CREATE TABLE `sms_n_email_status` (
  `id` int(11) NOT NULL,
  `status` varchar(45) DEFAULT NULL COMMENT 'Send , Delivered , Error'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `sms_n_email_status`
--

INSERT INTO `sms_n_email_status` (`id`, `status`) VALUES
(1, 'Send'),
(2, 'Delivered'),
(3, 'Error');
...
INSERT INTO `user` (`id`, `name`, `username`, `password`, `user_type_id`, `user_status_id`, `last_login`) VALUES
(2, 'test', 'test@lk.lk', '$2y$10$9Xftga4JXdLvl.8Bve9mmu9.rPOrGhRtYjZImeREzMY2iF8.K5vuu', 1, 1, '2025-07-13 23:12:20');
...
CREATE TABLE `user_manager` (
  ...
  `user_nationality_id` int(11) NOT NULL,
  `user_address_id` int(11) NOT NULL,
  `email` varchar(100) DEFAULT NULL,
  `phone` varchar(15) DEFAULT NULL,
  `whatapp` varchar(15) DEFAULT NULL,
...
--
-- Table structure for table `user_manager_roles`
--

CREATE TABLE `user_manager_roles` (
  `id` int(11) NOT NULL,
  `user_manager_id` int(11) NOT NULL,
...
--
-- Table structure for table `user_manager_skill`
--

CREATE TABLE `user_manager_skill` (
  `id` int(11) NOT NULL,
  `user_manager_id` int(11) NOT NULL,
...
--
-- Table structure for table `user_manager_work_history`
--

CREATE TABLE `user_manager_work_history` (
  `id` int(11) NOT NULL,
  `user_manager_id` int(11) NOT NULL,
...
INSERT INTO `user_nationality` (`id`, `nationality`) VALUES
(1, 'Default'),
(2, 'Sinhala'),
(3, 'Tamil'),
(4, 'Burgher');
...
--
-- Table structure for table `user_reg_req`
--

CREATE TABLE `user_reg_req` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `user_reg_req`
--

INSERT INTO `user_reg_req` (`id`, `custom_id`, `name`, `email`, `mobile`, `request_time`, `review_time`, `reviewer_id`) VALUES
(1, 'DID000001', 'sjay', 'test@local', '0112200500', '2025-07-13 22:09:57', NULL, NULL),
(2, 'DID000002', 'sjay', 'test@local', '0112200500', '2025-07-13 22:10:41', NULL, NULL),
(3, 'DID000003', 'sjay', 'test@local', '0112200500', '2025-07-13 22:11:16', NULL, NULL);

--
-- Triggers `user_reg_req`
--
DELIMITER $$
CREATE TRIGGER `before_insert_user_reg_req` BEFORE INSERT ON `user_reg_req` FOR EACH ROW BEGIN
    DECLARE next_id INT;

    -- Get next auto-increment value
    SELECT AUTO_INCREMENT INTO next_id
    FROM INFORMATION_SCHEMA.TABLES
    WHERE TABLE_NAME = 'user_reg_req'
    AND TABLE_SCHEMA = DATABASE();

    -- Format custom ID
    SET NEW.custom_id = CONCAT('DID', LPAD(next_id, 6, '0'));
END
$$
DELIMITER ;
...
CREATE TABLE `user_student` (
  ...
  `last_name` varchar(20) DEFAULT NULL,
  `full_name` text DEFAULT NULL,
  `first_name_japan` varchar(20) DEFAULT NULL,
  `middle_name_japan` varchar(20) DEFAULT NULL,
  `last_name_japan` varchar(20) DEFAULT NULL,
  `full_name_japan` text DEFAULT NULL,
  `dob` date DEFAULT NULL,
  `user_gender_id` int(11) NOT NULL,
  `user_nationality_id` int(11) NOT NULL,
...
--
-- Table structure for table `user_student_clubs`
--

CREATE TABLE `user_student_clubs` (
  `id` int(11) NOT NULL,
  `user_student_id` int(11) NOT NULL,
  ...
  `description` text DEFAULT NULL,
  `is_show_public` tinyint(4) DEFAULT 0,
  `is_show_cv` tinyint(4) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `user_student_contact`
--

CREATE TABLE `user_student_contact` (
  `id` int(11) NOT NULL,
  `user_student_id` int(11) NOT NULL,
  `mobile` varchar(15) DEFAULT NULL,
  ...
  `guardian2_name` varchar(45) DEFAULT NULL,
  `guardian2_relationship` varchar(45) DEFAULT NULL,
  `guardian2_phone` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `user_student_education`
--

CREATE TABLE `user_student_education` (
  `id` int(11) NOT NULL,
  `user_student_id` int(11) NOT NULL,
  `institution_name` varchar(255) DEFAULT NULL,
  `user_student_edu_exams_id` int(11) NOT NULL,
  `major` varchar(45) DEFAULT NULL,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `user_student_edu_result_id` int(11) NOT NULL,
  `special_note` text DEFAULT NULL,
  `is_show_public` tinyint(4) DEFAULT 0,
  `is_show_cv` tinyint(4) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `user_student_edu_details`
--

CREATE TABLE `user_student_edu_details` (
  `id` int(11) NOT NULL,
  `user_student_education_id` int(11) NOT NULL,
  `user_student_edu_subject_id` int(11) NOT NULL,
  `user_student_edu_result_id` int(11) NOT NULL,
  `note` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `user_student_edu_exams`
--

CREATE TABLE `user_student_edu_exams` (
  `id` int(11) NOT NULL,
  `exam` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `user_student_edu_exams`
--

INSERT INTO `user_student_edu_exams` (`id`, `exam`) VALUES
(1, 'GCE Ordinary Level (O/L)'),
(2, 'GCE Advanced Level (A/L)'),
(3, 'Diploma'),
(4, 'Higher Diploma'),
(5, 'Degree');
...
--
-- Table structure for table `user_student_edu_result`
--

CREATE TABLE `user_student_edu_result` (
  `id` int(11) NOT NULL,
  `result` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `user_student_edu_result`
--

INSERT INTO `user_student_edu_result` (`id`, `result`) VALUES
(1, 'Pass'),
(2, 'Failed'),
(3, 'A+'),
(4, 'A'),
...
--
-- Table structure for table `user_student_edu_subject`
--

CREATE TABLE `user_student_edu_subject` (
  `id` int(11) NOT NULL,
  `subject` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `user_student_edu_subject`
--

INSERT INTO `user_student_edu_subject` (`id`, `subject`) VALUES
(1, 'Sinhala'),
(2, 'Tamil'),
(3, 'English'),
(4, 'Mathematics'),
...
--
-- Table structure for table `user_student_feilds_list`
--

CREATE TABLE `user_student_feilds_list` (
  `id` int(11) NOT NULL,
  `feild` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `user_student_feilds_list`
--

INSERT INTO `user_student_feilds_list` (`id`, `feild`) VALUES
(1, 'Science'),
(2, 'Technology & IT'),
...
--
-- Table structure for table `user_student_has_hobby`
--

CREATE TABLE `user_student_has_hobby` (
  `id` int(11) NOT NULL,
  `user_student_id` int(11) NOT NULL,
  `user_student_hobby_id` int(11) NOT NULL,
  `note` varchar(255) DEFAULT NULL,
  `is_show_public` tinyint(4) DEFAULT 0,
  `is_show_cv` tinyint(4) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `user_student_has_skill`
--

CREATE TABLE `user_student_has_skill` (
  `id` int(11) NOT NULL,
  `user_student_id` int(11) NOT NULL,
  `user_student_skill_category_id` int(11) NOT NULL,
  `user_student_skill_id` int(11) NOT NULL,
  `note` varchar(255) DEFAULT NULL,
  `is_show_public` tinyint(4) DEFAULT 0,
  `is_show_cv` tinyint(4) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `user_student_hobby`
--

CREATE TABLE `user_student_hobby` (
  `id` int(11) NOT NULL,
  `hobby` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `user_student_hobby`
--

INSERT INTO `user_student_hobby` (`id`, `hobby`) VALUES
(1, 'Music'),
(2, 'Photography'),
(3, 'Painting'),
(4, 'Gaming'),
...
--
-- Table structure for table `user_student_licenses`
--

CREATE TABLE `user_student_licenses` (
  `id` int(11) NOT NULL,
  `user_student_id` int(11) NOT NULL,
  ...
  `credential_id` varchar(45) DEFAULT NULL,
  `note` varchar(255) DEFAULT NULL,
  `is_show_public` tinyint(4) DEFAULT 0,
  `is_show_cv` tinyint(4) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `user_student_photo`
--

CREATE TABLE `user_student_photo` (
  `id` int(11) NOT NULL,
  `user_student_id` int(11) NOT NULL,
  `path` varchar(255) DEFAULT NULL,
  `photo_type` int(11) DEFAULT 0 COMMENT 'photo_type -> profile photo => 0 , CV photo => 1 ...'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `user_student_preferred_feilds`
--

CREATE TABLE `user_student_preferred_feilds` (
  `id` int(11) NOT NULL,
  `user_student_id` int(11) NOT NULL,
  `user_student_feilds_list_id` int(11) NOT NULL,
  `description` varchar(255) DEFAULT NULL,
  `is_show_public` tinyint(4) DEFAULT 0,
  `is_show_cv` tinyint(4) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `user_student_skill`
--

CREATE TABLE `user_student_skill` (
  `id` int(11) NOT NULL,
  `skill` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `user_student_skill`
--

INSERT INTO `user_student_skill` (`id`, `skill`) VALUES
...
--
-- Table structure for table `user_student_skill_category`
--

CREATE TABLE `user_student_skill_category` (
  `id` int(11) NOT NULL,
  `skill_category` varchar(45) DEFAULT NULL COMMENT 'strongg knoladge , major at'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `user_student_skill_category`
--

INSERT INTO `user_student_skill_category` (`id`, `skill_category`) VALUES
(1, 'Strongg Knoladge'),
(2, 'Major At');
...
--
-- Table structure for table `user_student_work_history`
--

CREATE TABLE `user_student_work_history` (
  `id` int(11) NOT NULL,
  `user_student_id` int(11) NOT NULL,
...
--
-- Table structure for table `user_teacher_certificates`
--

CREATE TABLE `user_teacher_certificates` (
  `id` int(11) NOT NULL,
  `user_teacher_id` int(11) NOT NULL,
...
--
-- Table structure for table `user_teacher_education`
--

CREATE TABLE `user_teacher_education` (
  `id` int(11) NOT NULL,
  `user_teacher_id` int(11) NOT NULL,
  `institution_name` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `user_teacher_skills`
--

CREATE TABLE `user_teacher_skills` (
  `id` int(11) NOT NULL,
  `user_teacher_id` int(11) NOT NULL,
  `skill_name` varchar(45) DEFAULT NULL,
  `user_teacher_skill_level_id` int(11) NOT NULL,
  `description` text DEFAULT NULL,
  `is_show_public` tinyint(4) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `user_teacher_skill_level`
--

CREATE TABLE `user_teacher_skill_level` (
  `id` int(11) NOT NULL,
  `level` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `user_teacher_skill_level`
--

INSERT INTO `user_teacher_skill_level` (`id`, `level`) VALUES
(1, 'Beginner'),
(2, 'Intermediate'),
(3, 'Advanced'),
(4, 'Expert');
...
--
-- Table structure for table `user_teacher_specialties`
--

CREATE TABLE `user_teacher_specialties` (
  `id` int(11) NOT NULL,
  `user_teacher_id` int(11) NOT NULL,
...
--
-- Table structure for table `user_teacher_work_history`
--

CREATE TABLE `user_teacher_work_history` (
  `id` int(11) NOT NULL,
  `user_teacher_id` int(11) NOT NULL,
  `organization_name` varchar(100) DEFAULT NULL,
  `job_title` varchar(100) DEFAULT NULL,
...
ALTER TABLE `attendance`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_attendance_user_manager1_idx` (`user_manager_id`),
  ADD KEY `fk_attendance_user_teacher1_idx` (`user_teacher_id`);
...
ALTER TABLE `attendance_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_attendance_attendance1_idx` (`attendance_id`);
...
--
-- Indexes for table `class_assign_teachers`
--
ALTER TABLE `class_assign_teachers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_class_assign_teachers_class_shedule1_idx` (`class_shedule_id`),
  ADD KEY `fk_class_assign_teachers_course_has_teacher1_idx` (`course_has_teacher_id`),
  ADD KEY `fk_class_assign_teachers_class_teachet_roles1_idx` (`class_teachet_roles_id`);
...
ALTER TABLE `class_shedule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_class_shedule_class1_idx` (`class_id`),
  ADD KEY `fk_class_shedule_course1_idx` (`course_id`),
  ADD KEY `fk_class_shedule_class_shedule_status1_idx` (`class_shedule_status_id`);

--
-- Indexes for table `class_shedule_status`
--
ALTER TABLE `class_shedule_status`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `class_student_attendance`
--
ALTER TABLE `class_student_attendance`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_class_student_attendance_course_has_student1_idx` (`course_has_student_id`),
  ADD KEY `fk_class_student_attendance_class_shedule1_idx` (`class_shedule_id`);

--
-- Indexes for table `class_teachet_roles`
--
ALTER TABLE `class_teachet_roles`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `course_has_student`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_course_has_student_course1_idx` (`course_id`),
  ADD KEY `fk_course_has_student_user_student1_idx` (`user_student_id`);
...
--
-- Indexes for table `evenet_status`
--
ALTER TABLE `evenet_status`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `event`
  ...
  ADD KEY `fk_event_evenet_status1_idx` (`evenet_status_id`);

--
-- Indexes for table `event_oraganizer`
--
ALTER TABLE `event_oraganizer`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_event_oraganizer_event_shedule1_idx` (`event_shedule_id`),
  ADD KEY `fk_event_oraganizer_user1_idx` (`user_id`);
...
ALTER TABLE `event_participants`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_event_participants_event_shedule1_idx` (`event_shedule_id`),
  ADD KEY `fk_event_participants_user1_idx` (`user_id`),
  ADD KEY `fk_event_participants_event_participants_status1_idx` (`event_participants_status_id`);

--
-- Indexes for table `event_participants_status`
--
ALTER TABLE `event_participants_status`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `event_shedule`
--
ALTER TABLE `event_shedule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_event_shedule_event1_idx` (`event_id`),
  ADD KEY `fk_event_shedule_evenet_status1_idx` (`evenet_status_id`);
...
ALTER TABLE `payment_course`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_course_course1_idx` (`course_id`);
...
--
-- Indexes for table `payment_event`
--
ALTER TABLE `payment_event`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_event_event_participants1_idx` (`event_participants_id`),
  ADD KEY `fk_payment_event_payment_method1_idx` (`payment_method_id`),
  ADD KEY `fk_payment_event_payment_currency1_idx` (`payment_currency_id`),
  ADD KEY `fk_payment_event_payment_status1_idx` (`payment_status_id`);
...
ALTER TABLE `payment_expenses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_expenses_payment_expenses_type1_idx` (`payment_expenses_type_id`),
  ADD KEY `fk_payment_expenses_payment_status1_idx` (`payment_status_id`);

--
-- Indexes for table `payment_expenses_details`
--
ALTER TABLE `payment_expenses_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_expenses_details_payment_expenses1_idx` (`payment_expenses_id`),
  ADD KEY `fk_payment_expenses_details_payment_status1_idx` (`payment_status_id`),
  ADD KEY `fk_payment_expenses_details_payment_method1_idx` (`payment_method_id`),
  ADD KEY `fk_payment_expenses_details_payment_currency1_idx` (`payment_currency_id`);

--
-- Indexes for table `payment_expenses_type`
--
ALTER TABLE `payment_expenses_type`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `payment_salaries`
--
ALTER TABLE `payment_salaries`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_salaries_user_manager1_idx` (`user_manager_id`),
  ADD KEY `fk_payment_salaries_user_teacher1_idx` (`user_teacher_id`),
  ADD KEY `fk_payment_salaries_payment_status1_idx` (`payment_status_id`);

--
-- Indexes for table `payment_salaries_staff_bank_details`
--
ALTER TABLE `payment_salaries_staff_bank_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_salaries_staff_bank_details_payment_salaries_sta_idx` (`payment_salaries_staff_role_id`);

--
-- Indexes for table `payment_salaries_staff_paid_details`
--
ALTER TABLE `payment_salaries_staff_paid_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_salaries_staff_paid_details_payment_salaries_sta_idx` (`payment_salaries_staff_role_id`),
  ADD KEY `fk_payment_salaries_staff_paid_details_payment_method1_idx` (`payment_method_id`),
  ADD KEY `fk_payment_salaries_staff_paid_details_payment_currency1_idx` (`payment_currency_id`),
  ADD KEY `fk_payment_salaries_staff_paid_details_payment_status1_idx` (`payment_status_id`);

--
-- Indexes for table `payment_salaries_staff_role`
--
ALTER TABLE `payment_salaries_staff_role`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_salaries_staff_role_payment_salaries1_idx` (`payment_salaries_id`),
  ADD KEY `fk_payment_salaries_staff_role_payment_status1_idx` (`payment_status_id`);
...
ALTER TABLE `payment_student`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_student_user_student1_idx` (`user_student_id`),
  ADD KEY `fk_payment_student_payment_status1_idx` (`payment_status_id`);

--
-- Indexes for table `payment_student_details`
--
ALTER TABLE `payment_student_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_payment_student_details_payment_student1_idx` (`payment_student_id`),
  ADD KEY `fk_payment_student_details_payment_method1_idx` (`payment_method_id`),
  ADD KEY `fk_payment_student_details_payment_currency1_idx` (`payment_currency_id`),
  ADD KEY `fk_payment_student_details_payment_status1_idx` (`payment_status_id`),
  ADD KEY `fk_payment_student_details_payment_course1_idx` (`payment_course_id`);
...
--
-- Indexes for table `sms_n_email`
--
ALTER TABLE `sms_n_email`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_sms_n_email_user1_idx` (`user_id`),
  ADD KEY `fk_sms_n_email_sms_n_email_status1_idx` (`sms_n_email_status_id`),
  ADD KEY `fk_sms_n_email_sms_n_email_category1_idx` (`sms_n_email_category_id`);

--
-- Indexes for table `sms_n_email_category`
--
ALTER TABLE `sms_n_email_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sms_n_email_status`
--
ALTER TABLE `sms_n_email_status`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `user_address`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_address_cities1_idx` (`cities_id`);
...
ALTER TABLE `user_manager`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_manager_user1_idx` (`user_id`),
  ADD KEY `fk_user_manager_user_gender1_idx` (`user_gender_id`),
  ADD KEY `fk_user_manager_user_nationality1_idx` (`user_nationality_id`),
  ADD KEY `fk_user_manager_user_address1_idx` (`user_address_id`);

--
-- Indexes for table `user_manager_roles`
--
ALTER TABLE `user_manager_roles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_manager_roles_user_manager1_idx` (`user_manager_id`);

--
-- Indexes for table `user_manager_skill`
--
ALTER TABLE `user_manager_skill`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_manager_skill_user_manager1_idx` (`user_manager_id`);

--
-- Indexes for table `user_manager_work_history`
--
ALTER TABLE `user_manager_work_history`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_manager_work_history_user_manager1_idx` (`user_manager_id`);
...
--
-- Indexes for table `user_reg_req`
--
ALTER TABLE `user_reg_req`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `user_student`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_user1_idx` (`user_id`),
  ADD KEY `fk_user_student_user_gender1_idx` (`user_gender_id`),
  ADD KEY `fk_user_student_user_address1_idx` (`user_address_id`),
  ADD KEY `fk_user_student_user_nationality1_idx` (`user_nationality_id`);

--
-- Indexes for table `user_student_clubs`
--
ALTER TABLE `user_student_clubs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_clubs_user_student1_idx` (`user_student_id`);

--
-- Indexes for table `user_student_contact`
--
ALTER TABLE `user_student_contact`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_student_contact_user_student1_idx` (`user_student_id`);

--
-- Indexes for table `user_student_education`
--
ALTER TABLE `user_student_education`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_education_user_student1_idx` (`user_student_id`),
  ADD KEY `fk_user_student_education_user_student_edu_exams1_idx` (`user_student_edu_exams_id`),
  ADD KEY `fk_user_student_education_user_student_edu_result1_idx` (`user_student_edu_result_id`);

--
-- Indexes for table `user_student_edu_details`
--
ALTER TABLE `user_student_edu_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_edu_details_user_student_education1_idx` (`user_student_education_id`),
  ADD KEY `fk_user_student_edu_details_user_student_edu_subject1_idx` (`user_student_edu_subject_id`),
  ADD KEY `fk_user_student_edu_details_user_student_edu_result1_idx` (`user_student_edu_result_id`);

--
-- Indexes for table `user_student_edu_exams`
--
ALTER TABLE `user_student_edu_exams`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_student_edu_result`
--
ALTER TABLE `user_student_edu_result`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_student_edu_subject`
--
ALTER TABLE `user_student_edu_subject`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_student_feilds_list`
--
ALTER TABLE `user_student_feilds_list`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_student_has_hobby`
--
ALTER TABLE `user_student_has_hobby`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_has_hobby_user_student1_idx` (`user_student_id`),
  ADD KEY `fk_user_student_has_hobby_user_student_hobby1_idx` (`user_student_hobby_id`);

--
-- Indexes for table `user_student_has_skill`
--
ALTER TABLE `user_student_has_skill`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_skill_user_student1_idx` (`user_student_id`),
  ADD KEY `fk_user_student_has_skill_user_student_skill_category1_idx` (`user_student_skill_category_id`),
  ADD KEY `fk_user_student_has_skill_user_student_skill1_idx` (`user_student_skill_id`);

--
-- Indexes for table `user_student_hobby`
--
ALTER TABLE `user_student_hobby`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_student_licenses`
--
ALTER TABLE `user_student_licenses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_licenses_user_student1_idx` (`user_student_id`);

--
-- Indexes for table `user_student_photo`
--
ALTER TABLE `user_student_photo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_photo_user_student1_idx` (`user_student_id`);

--
-- Indexes for table `user_student_preferred_feilds`
--
ALTER TABLE `user_student_preferred_feilds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_preferred_feilds_user_student1_idx` (`user_student_id`),
  ADD KEY `fk_user_student_preferred_feilds_user_student_feilds_list1_idx` (`user_student_feilds_list_id`);

--
-- Indexes for table `user_student_skill`
--
ALTER TABLE `user_student_skill`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_student_skill_category`
--
ALTER TABLE `user_student_skill_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_student_work_history`
--
ALTER TABLE `user_student_work_history`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_student_work_history_user_student1_idx` (`user_student_id`);
...
ALTER TABLE `user_teacher`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_teacher_user1_idx` (`user_id`),
  ADD KEY `fk_user_teacher_user_gender1_idx` (`user_gender_id`),
  ADD KEY `fk_user_teacher_user_nationality1_idx` (`user_nationality_id`),
  ADD KEY `fk_user_teacher_user_address1_idx` (`user_address_id`);

--
-- Indexes for table `user_teacher_certificates`
--
ALTER TABLE `user_teacher_certificates`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_teacher_certificates_user_teacher1_idx` (`user_teacher_id`);

--
-- Indexes for table `user_teacher_education`
--
ALTER TABLE `user_teacher_education`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_teacher_education_user_teacher1_idx` (`user_teacher_id`);

--
-- Indexes for table `user_teacher_skills`
--
ALTER TABLE `user_teacher_skills`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_teacher_skills_user_teacher1_idx` (`user_teacher_id`),
  ADD KEY `fk_user_teacher_skills_user_teacher_skill_level1_idx` (`user_teacher_skill_level_id`);

--
-- Indexes for table `user_teacher_skill_level`
--
ALTER TABLE `user_teacher_skill_level`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_teacher_specialties`
--
ALTER TABLE `user_teacher_specialties`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_teacher_specialties_user_teacher1_idx` (`user_teacher_id`);

--
-- Indexes for table `user_teacher_work_history`
--
ALTER TABLE `user_teacher_work_history`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_teacher_work_history_user_teacher1_idx` (`user_teacher_id`);
...
--
-- AUTO_INCREMENT for table `class_assign_teachers`
--
ALTER TABLE `class_assign_teachers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `class_shedule_status`
--
ALTER TABLE `class_shedule_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `class_student_attendance`
--
ALTER TABLE `class_student_attendance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `class_teachet_roles`
--
ALTER TABLE `class_teachet_roles`
...
--
-- AUTO_INCREMENT for table `evenet_status`
--
ALTER TABLE `evenet_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `event_oraganizer`
--
ALTER TABLE `event_oraganizer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `event_participants_status`
--
ALTER TABLE `event_participants_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `event_shedule`
--
ALTER TABLE `event_shedule`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `payment_event`
--
ALTER TABLE `payment_event`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `payment_expenses_details`
--
ALTER TABLE `payment_expenses_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `payment_expenses_type`
--
ALTER TABLE `payment_expenses_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `payment_salaries`
--
ALTER TABLE `payment_salaries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `payment_salaries_staff_bank_details`
--
ALTER TABLE `payment_salaries_staff_bank_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `payment_salaries_staff_paid_details`
--
ALTER TABLE `payment_salaries_staff_paid_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `payment_salaries_staff_role`
--
ALTER TABLE `payment_salaries_staff_role`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `sms_n_email`
--
ALTER TABLE `sms_n_email`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sms_n_email_category`
--
ALTER TABLE `sms_n_email_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `sms_n_email_status`
--
ALTER TABLE `sms_n_email_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `user_manager_roles`
--
ALTER TABLE `user_manager_roles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_manager_skill`
--
ALTER TABLE `user_manager_skill`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_manager_work_history`
--
ALTER TABLE `user_manager_work_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `user_reg_req`
--
ALTER TABLE `user_reg_req`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `user_student_clubs`
--
ALTER TABLE `user_student_clubs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_student_contact`
--
ALTER TABLE `user_student_contact`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_student_education`
--
ALTER TABLE `user_student_education`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_student_edu_details`
--
ALTER TABLE `user_student_edu_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_student_edu_exams`
--
ALTER TABLE `user_student_edu_exams`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `user_student_edu_result`
--
ALTER TABLE `user_student_edu_result`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `user_student_edu_subject`
--
ALTER TABLE `user_student_edu_subject`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `user_student_feilds_list`
--
ALTER TABLE `user_student_feilds_list`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `user_student_has_hobby`
--
ALTER TABLE `user_student_has_hobby`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_student_has_skill`
--
ALTER TABLE `user_student_has_skill`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_student_hobby`
--
ALTER TABLE `user_student_hobby`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `user_student_licenses`
--
ALTER TABLE `user_student_licenses`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_student_photo`
--
ALTER TABLE `user_student_photo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_student_preferred_feilds`
--
ALTER TABLE `user_student_preferred_feilds`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_student_skill`
--
ALTER TABLE `user_student_skill`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `user_student_skill_category`
--
ALTER TABLE `user_student_skill_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `user_student_work_history`
--
ALTER TABLE `user_student_work_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `user_teacher_certificates`
--
ALTER TABLE `user_teacher_certificates`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_teacher_education`
--
ALTER TABLE `user_teacher_education`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_teacher_skills`
--
ALTER TABLE `user_teacher_skills`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_teacher_skill_level`
--
ALTER TABLE `user_teacher_skill_level`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `user_teacher_specialties`
--
ALTER TABLE `user_teacher_specialties`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_teacher_work_history`
--
ALTER TABLE `user_teacher_work_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `fk_attendance_user_manager1` FOREIGN KEY (`user_manager_id`) REFERENCES `user_manager` (`id`),
  ADD CONSTRAINT `fk_attendance_user_teacher1` FOREIGN KEY (`user_teacher_id`) REFERENCES `user_teacher` (`id`);

--
-- Constraints for table `attendance_details`
--
ALTER TABLE `attendance_details`
  ADD CONSTRAINT `fk_attendance_attendance1` FOREIGN KEY (`attendance_id`) REFERENCES `attendance` (`id`);

--
-- Constraints for table `cities`
--
ALTER TABLE `cities`
  ADD CONSTRAINT `fk_cities_districts1` FOREIGN KEY (`districts_id`) REFERENCES `districts` (`id`);

--
-- Constraints for table `class_assign_teachers`
--
ALTER TABLE `class_assign_teachers`
  ADD CONSTRAINT `fk_class_assign_teachers_class_shedule1` FOREIGN KEY (`class_shedule_id`) REFERENCES `class_shedule` (`id`),
  ADD CONSTRAINT `fk_class_assign_teachers_class_teachet_roles1` FOREIGN KEY (`class_teachet_roles_id`) REFERENCES `class_teachet_roles` (`id`),
  ADD CONSTRAINT `fk_class_assign_teachers_course_has_teacher1` FOREIGN KEY (`course_has_teacher_id`) REFERENCES `course_has_teacher` (`id`);

--
-- Constraints for table `class_shedule`
--
ALTER TABLE `class_shedule`
  ADD CONSTRAINT `fk_class_shedule_class1` FOREIGN KEY (`class_id`) REFERENCES `class` (`id`),
  ADD CONSTRAINT `fk_class_shedule_class_shedule_status1` FOREIGN KEY (`class_shedule_status_id`) REFERENCES `class_shedule_status` (`id`),
  ADD CONSTRAINT `fk_class_shedule_course1` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`);

--
-- Constraints for table `class_student_attendance`
--
ALTER TABLE `class_student_attendance`
  ADD CONSTRAINT `fk_class_student_attendance_class_shedule1` FOREIGN KEY (`class_shedule_id`) REFERENCES `class_shedule` (`id`),
  ADD CONSTRAINT `fk_class_student_attendance_course_has_student1` FOREIGN KEY (`course_has_student_id`) REFERENCES `course_has_student` (`id`);

--
-- Constraints for table `course`
--
ALTER TABLE `course`
  ADD CONSTRAINT `fk_course_course_level1` FOREIGN KEY (`course_level_id`) REFERENCES `course_level` (`id`);

--
-- Constraints for table `course_has_student`
--
ALTER TABLE `course_has_student`
  ADD CONSTRAINT `fk_course_has_student_course1` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`),
  ADD CONSTRAINT `fk_course_has_student_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`);

--
-- Constraints for table `districts`
--
ALTER TABLE `districts`
  ADD CONSTRAINT `fk_districts_provinces1` FOREIGN KEY (`provinces_id`) REFERENCES `provinces` (`id`);

--
-- Constraints for table `event`
--
ALTER TABLE `event`
  ADD CONSTRAINT `fk_event_evenet_status1` FOREIGN KEY (`evenet_status_id`) REFERENCES `evenet_status` (`id`),
  ADD CONSTRAINT `fk_event_event_type1` FOREIGN KEY (`event_type_id`) REFERENCES `event_type` (`id`);

--
-- Constraints for table `event_oraganizer`
--
ALTER TABLE `event_oraganizer`
  ADD CONSTRAINT `fk_event_oraganizer_event_shedule1` FOREIGN KEY (`event_shedule_id`) REFERENCES `event_shedule` (`id`),
  ADD CONSTRAINT `fk_event_oraganizer_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `event_participants`
--
ALTER TABLE `event_participants`
  ADD CONSTRAINT `fk_event_participants_event_participants_status1` FOREIGN KEY (`event_participants_status_id`) REFERENCES `event_participants_status` (`id`),
  ADD CONSTRAINT `fk_event_participants_event_shedule1` FOREIGN KEY (`event_shedule_id`) REFERENCES `event_shedule` (`id`),
  ADD CONSTRAINT `fk_event_participants_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `event_shedule`
--
ALTER TABLE `event_shedule`
  ADD CONSTRAINT `fk_event_shedule_evenet_status1` FOREIGN KEY (`evenet_status_id`) REFERENCES `evenet_status` (`id`),
  ADD CONSTRAINT `fk_event_shedule_event1` FOREIGN KEY (`event_id`) REFERENCES `event` (`id`);

--
-- Constraints for table `payment_course`
--
ALTER TABLE `payment_course`
  ADD CONSTRAINT `fk_payment_course_course1` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`);

--
-- Constraints for table `payment_event`
--
ALTER TABLE `payment_event`
  ADD CONSTRAINT `fk_payment_event_event_participants1` FOREIGN KEY (`event_participants_id`) REFERENCES `event_participants` (`id`),
  ADD CONSTRAINT `fk_payment_event_payment_currency1` FOREIGN KEY (`payment_currency_id`) REFERENCES `payment_currency` (`id`),
  ADD CONSTRAINT `fk_payment_event_payment_method1` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_method` (`id`),
  ADD CONSTRAINT `fk_payment_event_payment_status1` FOREIGN KEY (`payment_status_id`) REFERENCES `payment_status` (`id`);

--
-- Constraints for table `payment_expenses`
--
ALTER TABLE `payment_expenses`
  ADD CONSTRAINT `fk_payment_expenses_payment_expenses_type1` FOREIGN KEY (`payment_expenses_type_id`) REFERENCES `payment_expenses_type` (`id`),
  ADD CONSTRAINT `fk_payment_expenses_payment_status1` FOREIGN KEY (`payment_status_id`) REFERENCES `payment_status` (`id`);

--
-- Constraints for table `payment_expenses_details`
--
ALTER TABLE `payment_expenses_details`
  ADD CONSTRAINT `fk_payment_expenses_details_payment_currency1` FOREIGN KEY (`payment_currency_id`) REFERENCES `payment_currency` (`id`),
  ADD CONSTRAINT `fk_payment_expenses_details_payment_expenses1` FOREIGN KEY (`payment_expenses_id`) REFERENCES `payment_expenses` (`id`),
  ADD CONSTRAINT `fk_payment_expenses_details_payment_method1` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_method` (`id`),
  ADD CONSTRAINT `fk_payment_expenses_details_payment_status1` FOREIGN KEY (`payment_status_id`) REFERENCES `payment_status` (`id`);

--
-- Constraints for table `payment_salaries`
--
ALTER TABLE `payment_salaries`
  ADD CONSTRAINT `fk_payment_salaries_payment_status1` FOREIGN KEY (`payment_status_id`) REFERENCES `payment_status` (`id`),
  ADD CONSTRAINT `fk_payment_salaries_user_manager1` FOREIGN KEY (`user_manager_id`) REFERENCES `user_manager` (`id`),
  ADD CONSTRAINT `fk_payment_salaries_user_teacher1` FOREIGN KEY (`user_teacher_id`) REFERENCES `user_teacher` (`id`);

--
-- Constraints for table `payment_salaries_staff_bank_details`
--
ALTER TABLE `payment_salaries_staff_bank_details`
  ADD CONSTRAINT `fk_payment_salaries_staff_bank_details_payment_salaries_staff1` FOREIGN KEY (`payment_salaries_staff_role_id`) REFERENCES `payment_salaries_staff_role` (`id`);

--
-- Constraints for table `payment_salaries_staff_paid_details`
--
ALTER TABLE `payment_salaries_staff_paid_details`
  ADD CONSTRAINT `fk_payment_salaries_staff_paid_details_payment_currency1` FOREIGN KEY (`payment_currency_id`) REFERENCES `payment_currency` (`id`),
  ADD CONSTRAINT `fk_payment_salaries_staff_paid_details_payment_method1` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_method` (`id`),
  ADD CONSTRAINT `fk_payment_salaries_staff_paid_details_payment_salaries_staff1` FOREIGN KEY (`payment_salaries_staff_role_id`) REFERENCES `payment_salaries_staff_role` (`id`),
  ADD CONSTRAINT `fk_payment_salaries_staff_paid_details_payment_status1` FOREIGN KEY (`payment_status_id`) REFERENCES `payment_status` (`id`);

--
-- Constraints for table `payment_salaries_staff_role`
--
ALTER TABLE `payment_salaries_staff_role`
  ADD CONSTRAINT `fk_payment_salaries_staff_role_payment_salaries1` FOREIGN KEY (`payment_salaries_id`) REFERENCES `payment_salaries` (`id`),
  ADD CONSTRAINT `fk_payment_salaries_staff_role_payment_status1` FOREIGN KEY (`payment_status_id`) REFERENCES `payment_status` (`id`);

--
-- Constraints for table `payment_student`
--
ALTER TABLE `payment_student`
  ADD CONSTRAINT `fk_payment_student_payment_status1` FOREIGN KEY (`payment_status_id`) REFERENCES `payment_status` (`id`),
  ADD CONSTRAINT `fk_payment_student_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`);

--
-- Constraints for table `payment_student_details`
--
ALTER TABLE `payment_student_details`
  ADD CONSTRAINT `fk_payment_student_details_payment_course1` FOREIGN KEY (`payment_course_id`) REFERENCES `payment_course` (`id`),
  ADD CONSTRAINT `fk_payment_student_details_payment_currency1` FOREIGN KEY (`payment_currency_id`) REFERENCES `payment_currency` (`id`),
  ADD CONSTRAINT `fk_payment_student_details_payment_method1` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_method` (`id`),
  ADD CONSTRAINT `fk_payment_student_details_payment_status1` FOREIGN KEY (`payment_status_id`) REFERENCES `payment_status` (`id`),
  ADD CONSTRAINT `fk_payment_student_details_payment_student1` FOREIGN KEY (`payment_student_id`) REFERENCES `payment_student` (`id`);

--
-- Constraints for table `sms_n_email`
--
ALTER TABLE `sms_n_email`
  ADD CONSTRAINT `fk_sms_n_email_sms_n_email_category1` FOREIGN KEY (`sms_n_email_category_id`) REFERENCES `sms_n_email_category` (`id`),
  ADD CONSTRAINT `fk_sms_n_email_sms_n_email_status1` FOREIGN KEY (`sms_n_email_status_id`) REFERENCES `sms_n_email_status` (`id`),
  ADD CONSTRAINT `fk_sms_n_email_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `fk_user_user_status1` FOREIGN KEY (`user_status_id`) REFERENCES `user_status` (`id`),
...
--
ALTER TABLE `user_address`
  ADD CONSTRAINT `fk_user_address_cities1` FOREIGN KEY (`cities_id`) REFERENCES `cities` (`id`);

--
-- Constraints for table `user_manager`
--
ALTER TABLE `user_manager`
  ADD CONSTRAINT `fk_user_manager_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `fk_user_manager_user_address1` FOREIGN KEY (`user_address_id`) REFERENCES `user_address` (`id`),
  ADD CONSTRAINT `fk_user_manager_user_gender1` FOREIGN KEY (`user_gender_id`) REFERENCES `user_gender` (`id`),
  ADD CONSTRAINT `fk_user_manager_user_nationality1` FOREIGN KEY (`user_nationality_id`) REFERENCES `user_nationality` (`id`);

--
-- Constraints for table `user_manager_roles`
--
ALTER TABLE `user_manager_roles`
  ADD CONSTRAINT `fk_user_manager_roles_user_manager1` FOREIGN KEY (`user_manager_id`) REFERENCES `user_manager` (`id`);

--
-- Constraints for table `user_manager_skill`
--
ALTER TABLE `user_manager_skill`
  ADD CONSTRAINT `fk_user_manager_skill_user_manager1` FOREIGN KEY (`user_manager_id`) REFERENCES `user_manager` (`id`);

--
-- Constraints for table `user_manager_work_history`
--
ALTER TABLE `user_manager_work_history`
  ADD CONSTRAINT `fk_user_manager_work_history_user_manager1` FOREIGN KEY (`user_manager_id`) REFERENCES `user_manager` (`id`);

--
-- Constraints for table `user_student`
--
ALTER TABLE `user_student`
  ADD CONSTRAINT `fk_user_student_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `fk_user_student_user_address1` FOREIGN KEY (`user_address_id`) REFERENCES `user_address` (`id`),
  ADD CONSTRAINT `fk_user_student_user_gender1` FOREIGN KEY (`user_gender_id`) REFERENCES `user_gender` (`id`),
  ADD CONSTRAINT `fk_user_student_user_nationality1` FOREIGN KEY (`user_nationality_id`) REFERENCES `user_nationality` (`id`);

--
-- Constraints for table `user_student_clubs`
--
ALTER TABLE `user_student_clubs`
  ADD CONSTRAINT `fk_user_student_clubs_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`);

--
-- Constraints for table `user_student_contact`
--
ALTER TABLE `user_student_contact`
  ADD CONSTRAINT `fk_student_contact_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`);

--
-- Constraints for table `user_student_education`
--
ALTER TABLE `user_student_education`
  ADD CONSTRAINT `fk_user_student_education_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`),
  ADD CONSTRAINT `fk_user_student_education_user_student_edu_exams1` FOREIGN KEY (`user_student_edu_exams_id`) REFERENCES `user_student_edu_exams` (`id`),
  ADD CONSTRAINT `fk_user_student_education_user_student_edu_result1` FOREIGN KEY (`user_student_edu_result_id`) REFERENCES `user_student_edu_result` (`id`);

--
-- Constraints for table `user_student_edu_details`
--
ALTER TABLE `user_student_edu_details`
  ADD CONSTRAINT `fk_user_student_edu_details_user_student_edu_result1` FOREIGN KEY (`user_student_edu_result_id`) REFERENCES `user_student_edu_result` (`id`),
  ADD CONSTRAINT `fk_user_student_edu_details_user_student_edu_subject1` FOREIGN KEY (`user_student_edu_subject_id`) REFERENCES `user_student_edu_subject` (`id`),
  ADD CONSTRAINT `fk_user_student_edu_details_user_student_education1` FOREIGN KEY (`user_student_education_id`) REFERENCES `user_student_education` (`id`);

--
-- Constraints for table `user_student_has_hobby`
--
ALTER TABLE `user_student_has_hobby`
  ADD CONSTRAINT `fk_user_student_has_hobby_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`),
  ADD CONSTRAINT `fk_user_student_has_hobby_user_student_hobby1` FOREIGN KEY (`user_student_hobby_id`) REFERENCES `user_student_hobby` (`id`);

--
-- Constraints for table `user_student_has_skill`
--
ALTER TABLE `user_student_has_skill`
  ADD CONSTRAINT `fk_user_student_has_skill_user_student_skill1` FOREIGN KEY (`user_student_skill_id`) REFERENCES `user_student_skill` (`id`),
  ADD CONSTRAINT `fk_user_student_has_skill_user_student_skill_category1` FOREIGN KEY (`user_student_skill_category_id`) REFERENCES `user_student_skill_category` (`id`),
  ADD CONSTRAINT `fk_user_student_skill_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`);

--
-- Constraints for table `user_student_licenses`
--
ALTER TABLE `user_student_licenses`
  ADD CONSTRAINT `fk_user_student_licenses_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`);

--
-- Constraints for table `user_student_photo`
--
ALTER TABLE `user_student_photo`
  ADD CONSTRAINT `fk_user_student_photo_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`);

--
-- Constraints for table `user_student_preferred_feilds`
--
ALTER TABLE `user_student_preferred_feilds`
  ADD CONSTRAINT `fk_user_student_preferred_feilds_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`),
  ADD CONSTRAINT `fk_user_student_preferred_feilds_user_student_feilds_list1` FOREIGN KEY (`user_student_feilds_list_id`) REFERENCES `user_student_feilds_list` (`id`);

--
-- Constraints for table `user_student_work_history`
--
ALTER TABLE `user_student_work_history`
  ADD CONSTRAINT `fk_user_student_work_history_user_student1` FOREIGN KEY (`user_student_id`) REFERENCES `user_student` (`id`);

--
-- Constraints for table `user_teacher`
--
ALTER TABLE `user_teacher`
  ADD CONSTRAINT `fk_user_teacher_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `fk_user_teacher_user_address1` FOREIGN KEY (`user_address_id`) REFERENCES `user_address` (`id`),
  ADD CONSTRAINT `fk_user_teacher_user_gender1` FOREIGN KEY (`user_gender_id`) REFERENCES `user_gender` (`id`),
  ADD CONSTRAINT `fk_user_teacher_user_nationality1` FOREIGN KEY (`user_nationality_id`) REFERENCES `user_nationality` (`id`);

--
-- Constraints for table `user_teacher_certificates`
--
ALTER TABLE `user_teacher_certificates`
  ADD CONSTRAINT `fk_user_teacher_certificates_user_teacher1` FOREIGN KEY (`user_teacher_id`) REFERENCES `user_teacher` (`id`);

--
-- Constraints for table `user_teacher_education`
--
ALTER TABLE `user_teacher_education`
  ADD CONSTRAINT `fk_user_teacher_education_user_teacher1` FOREIGN KEY (`user_teacher_id`) REFERENCES `user_teacher` (`id`);

--
-- Constraints for table `user_teacher_skills`
--
ALTER TABLE `user_teacher_skills`
  ADD CONSTRAINT `fk_user_teacher_skills_user_teacher1` FOREIGN KEY (`user_teacher_id`) REFERENCES `user_teacher` (`id`),
  ADD CONSTRAINT `fk_user_teacher_skills_user_teacher_skill_level1` FOREIGN KEY (`user_teacher_skill_level_id`) REFERENCES `user_teacher_skill_level` (`id`);

--
-- Constraints for table `user_teacher_specialties`
--
ALTER TABLE `user_teacher_specialties`
  ADD CONSTRAINT `fk_user_teacher_specialties_user_teacher1` FOREIGN KEY (`user_teacher_id`) REFERENCES `user_teacher` (`id`);

--
-- Constraints for table `user_teacher_work_history`
--
ALTER TABLE `user_teacher_work_history`
  ADD CONSTRAINT `fk_user_teacher_work_history_user_teacher1` FOREIGN KEY (`user_teacher_id`) REFERENCES `user_teacher` (`id`);
COMMIT;
